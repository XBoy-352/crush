...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	q := Queries{db: db}
	var err error
	if q.copyMessagesUpToCheckpointStmt, err = db.PrepareContext(ctx, copyMessagesUpToCheckpoint); err != nil {
		return nil, fmt.Errorf("error preparing query CopyMessagesUpToCheckpoint: %w", err)
	}
	if q.createFileStmt, err = db.PrepareContext(ctx, createFile); err != nil {
		return nil, fmt.Errorf("error preparing query CreateFile: %w", err)
	}
	if q.createForkedSessionStmt, err = db.PrepareContext(ctx, createForkedSession); err != nil {
		return nil, fmt.Errorf("error preparing query CreateForkedSession: %w", err)
	}
	...
	if q.deleteFileVersionsByIDStmt, err = db.PrepareContext(ctx, deleteFileVersionsByID); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteFileVersionsByID: %w", err)
	}
	...
	if q.listForksStmt, err = db.PrepareContext(ctx, listForks); err != nil {
		return nil, fmt.Errorf("error preparing query ListForks: %w", err)
	}
	...
	if q.listMessagesFromCheckpointStmt, err = db.PrepareContext(ctx, listMessagesFromCheckpoint); err != nil {
		return nil, fmt.Errorf("error preparing query ListMessagesFromCheckpoint: %w", err)
	}
...
func (q *Queries) Close() error {
	var err error
	if q.copyMessagesUpToCheckpointStmt != nil {
		if cerr := q.copyMessagesUpToCheckpointStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing copyMessagesUpToCheckpointStmt: %w", cerr)
		}
	}
	...
	if q.createForkedSessionStmt != nil {
		if cerr := q.createForkedSessionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createForkedSessionStmt: %w", cerr)
		}
	}
	...
	if q.deleteFileVersionsByIDStmt != nil {
		if cerr := q.deleteFileVersionsByIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteFileVersionsByIDStmt: %w", cerr)
		}
	}
	...
	if q.deleteMessagesFromCheckpointStmt != nil {
		if cerr := q.deleteMessagesFromCheckpointStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteMessagesFromCheckpointStmt: %w", cerr)
		}
	}
	...
	if q.listForksStmt != nil {
		if cerr := q.listForksStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listForksStmt: %w", cerr)
		}
	}
	...
	if q.listMessagesFromCheckpointStmt != nil {
		if cerr := q.listMessagesFromCheckpointStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listMessagesFromCheckpointStmt: %w", cerr)
		}
	}
...
type Queries struct {
	db                                   DBTX
	tx                                   *sql.Tx
	copyMessagesUpToCheckpointStmt       *sql.Stmt
	createFileStmt                       *sql.Stmt
	createForkedSessionStmt              *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		db:                                   tx,
		tx:                                   tx,
		copyMessagesUpToCheckpointStmt:       q.copyMessagesUpToCheckpointStmt,
		createFileStmt:                       q.createFileStmt,
		createForkedSessionStmt:              q.createForkedSessionStmt,

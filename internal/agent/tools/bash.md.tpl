...
2. Security Check: Sensitive commands ({{ .SensitiveCommands }}) require explicit human approval and can never be auto-approved; call them and wait for the user's grant. Safe read-only commands execute without prompts

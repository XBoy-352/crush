...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/sessions/{sid}/children", c.handleGetWorkspaceSessionChildren)
	mux.HandleFunc("GET /v1/workspaces/{id}/sessions/{sid}/forks", c.handleGetWorkspaceSessionForks)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/sessions/{sid}/background", c.handlePostWorkspaceAgentSessionBackground)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/sessions/{sid}/revert/{mid}", c.handlePostWorkspaceAgentSessionRevert)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/config/clear-model-overrides", c.handlePostWorkspaceConfigClearModelOverrides)
